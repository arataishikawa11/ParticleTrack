...
z_p = np.full(projections,[initial_pos[2]]) # constant z across projections and object frames (rotation is about z axis)
...
y_p = np.full(projections, np.nan) # y coord in projection doesn't exist (2D)
print(y_p)
